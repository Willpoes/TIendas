    ...
    <body style="">
        ...
        <footer class="footer-social-icon text-center section_padding_70 clearfix">
            ...
            <div class="footer-social-icon">
                <a href="https://www.facebook.com/Plataforma-de-comercio-electr%C3%B3nico-106589884401682/?modal=admin_todo_tour"><i class="fa fa-facebook active" aria-hidden="true"></i></a>
