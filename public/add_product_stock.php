...
// var_dump( $user['email'] );
$product = [];
if(isset($_GET['produc_id']) && $_GET['produc_id']!==""){
			...
			<div class="add-product" style="max-width: 720px;">
				...
				<form class="myStock" action="<?php echo '../private/' . $redirected_link; ?>" method="POST" enctype="multipart/form-data">
					...
					<div class="widget-content widget-content-area creative2-accordion-content">
                                <div id="creativeAccordion">
                                  ...
                                  <div class="card mb-3">
                                    ...
                                    <div id="creative2CollapseTwo" class="collapse show" aria-labelledby="creative2HeadingTwo" data-parent="#creativeAccordion">
                                      <div class="card-body">
                                            <?php
                                            if(!empty($_GET) && isset($_GET['produc_id']) && $_GET['produc_id']!==""){
                                                $product_medidas = medidas_product_by_id($_GET['produc_id']);
                                        //         $product_category == "49" || $product_category == "59" || $product_category == "60" || $product_category == "61" || $product_category == "62" || $product_category == "63" || $product_category == "64" || $product_category == "65" || $product_category == "66" || $product_category == "67" || $product_category=="82" 
                        			             //   || $product_category=="85" || $product_category=="86" || $product_category=="87" || $product_category=="88" || $product_category=="89" || $product_category=="90" || $product_category=="91" || $product_category=="92"  || $product_category=="99" || $product_category=="110" || $product_category=="111" || $product_category=="112" || $product_category=="113" || $product_category=="117" || $product_category=="126" || $product_category=="129"
                                                if($tipoTabla==1){
                                                    ?>
                            ...
                            //                     $product_category == "68" || $product_category == "69" || $product_category == "70" || $product_category == "71"
                        			 //|| $product_category == "84" || $product_category == "93" || $product_category == "94" || $product_category == "95"
                        			 // || $product_category == "96" || $product_category == "97" || $product_category == "98" || $product_category == "100"
                        			 //  || $product_category == "114" || $product_category == "115" || $product_category == "116" || $product_category == "118" || $product_category == "119"
                                                if($tipoTabla==2){
                                                    ?>
                                                    <div class="default-repeater mt-3">
                                                        <div class="table-dinamyc" id="medida-camisa-blusa" class="medida-camisa">
