...
function prueba_notificacion( msj ) {
    if (Notification) {
  ...
  <?php
   if ($_SESSION['grobaltype']==0){
    ...
    ?>
        ...
        <!-- == Begin Notification ==  -->
          <li>
            <a  class="dropdown-toggle rn-link" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <?php
        ...
        ?>
            ...
            <div class="dropdown-menu rn-left">
                <div class="dropdown-menu-inner">
                    ...
                    <ul>
                        <li><a href="seller.php?view=si"><i class="fas fa-user-alt"></i><?php echo $lang['Tiene'] ?> <span style="background-color: yellow"><?= $vende_nuevo ?></span> <?php echo $lang['VendedoresNuevos'] ?></a></li>
      ...
      <script>
        ...
        prueba_notificacion("Tienes vendedores nuevos.");
      </script>
  ...
  // ============= PEDIDOS NUEVOS (TIPO VENDEDOR)
   if ($_SESSION['grobaltype']==2){
    ...
    ?>
        ...
        ?>
            ...
            <div class="dropdown-menu rn-left">
                <div class="dropdown-menu-inner">
                    <div class="arrow-up"></div>
                    <ul>
                        <li><a href="list_order_user.php?view_pedidos=si"><i class="fas fa-user-alt"></i><?php echo $lang['Tiene'] ?> <span style="background-color: yellow"><?= $vende_nuevo ?></span> <?php echo $lang['VendedoresNuevos'] ?></a></li>
      ...
      <script>
        // llamo a la notificacion
        prueba_notificacion("Tienes Pedidos Nuevos.");
      </script>
        <audio  id="audio" autoplay >
          <source src="https://mishasho.com/moda-admin/public/audio/got-it-done.ogg" type="audio/ogg">
        </audio>
...
?>
        ...
        <li class="dropdown"><a  class="dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <img class="admin-img" src="images/profile_default.jpg" alt="">
            ...
            <div class="dropdown-menu">
                <div class="dropdown-menu-inner">
                    <div class="arrow-up"></div>
                    <ul>
                        <li><a href="admin_profile.php?admin_id=<?php echo $admin_id; ?>"><i class="fas fa-user-alt"></i><?php echo $lang['MiCuenta'] ?></a></li>
                        <li><a href="logout.php"><i class="fas fa-sign-out-alt"></i><?php echo $lang['Salir'] ?></a></li>
                    </ul>
  ...
  <img class="admin-img"  width="20%" src="images/profile_default.jpg" alt="">
                <?php echo $_SESSION['fullname']; ?><i class="fas fa-angle-down"></i>
</a>
