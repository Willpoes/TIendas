...
}elseif ($_GET['pagina']=="actualizar_user"){
...
echo $users;
}elseif ($_GET['pagina']=="actualizar_estadoy_order"){
...
}elseif ($_GET['pagina']=="actualizar_estado_order"){
...
$users = update_status_order_id($user);

echo $users;

} elseif ($_GET['pagina']=="mandarvariable"){

$_SESSION['SWVV'] = $_GET['swvv'];
//echo $product;

}elseif ($_GET['pagina']=="contarpedidos"){
