...
if(!empty($_POST)){
	...
	//$ordered_products['date'] = date("Y-m-d H:i:s"); 
	...
	$cuerpo .= "<h1>Tiene un pedido <a href='https://gamarritas.com/consultas/index.php?order_id=".$_POST['order_id']."#'>CLICK AQUI</a></h1>";
	$cuerpo .= "<p>atte</p>";
