...
if (!empty($_POST)) {
    ...
    if ($address_id == -1){
        ...
        //if (($Address_Line_1 != $address['address_line_1']) || ($Address_Line_2 != $address['address_line_2']) || ($City != $address['city']) ||  ($Zipcode != $address['zip_code']) || ($State != $address['state']) || ($Country != $address['country'])
        // ) {
