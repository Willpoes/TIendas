...
<header>
  <div class="left-area">
    <a class="logo" href="index.php"><img src="<?php echo $site_logo; ?>" alt=""><b
        class="hide-md"><?php echo $site_name; ?></b></a>
  </div><!-- left-area -->
  ...
  <ul class="right-area">
      ...
      <li>
        ...
        <div class="dropdown-menu rn-left">
          <div class="dropdown-menu-inner">
            ...
            <ul>
              <li><a href="seller.php?view=si"><i class="fas fa-user-alt"></i><?php echo $lang['Tiene'] ?> <span
                    style="background-color: yellow"><?= $vende_nuevo ?></span>
                  <?php echo $lang['VendedoresNuevos'] ?></a></li>
      ...
      <li>
        ...
        <div class="dropdown-menu rn-left">
          <div class="dropdown-menu-inner">
            <div class="arrow-up"></div>
            <ul>
              <li><a href="list_order_user.php?view_pedidos=si"><i
                    class="fas fa-user-alt"></i><?php echo $lang['Tiene'] ?> <span
                    style="background-color: yellow"><?= $vende_nuevo ?></span>
                  <?php echo $lang['VendedoresNuevos'] ?></a></li>
    ...
    <li><a href="#">
        ...
        <?php echo $_SESSION['fullname']; ?><i class="fas fa-angle-down"></i></a>

      <div class="dropdown-menu">
        <div class="dropdown-menu-inner">
          <div class="arrow-up"></div>
          <ul>
            <li><a href="admin_profile.php?admin_id=<?php echo $admin_id; ?>"><i
                  class="fas fa-user-alt"></i><?php echo $lang['MiCuenta'] ?></a></li>
