...
<script src="./js/sweetalert2/dist/sweetalert2.css"></script>
            ...
            $(document).ready(function () {
                Swal.fire({
                    ...
                    html: '<section class="special-area bg-white section_padding_100" id="about">' +
                            ...
                            '<img src="./img/chicooo.webp" width="300" height="300">' +
                            '</i>' +
                            '</div>' +
                            '</div>' +
                            '</div>' +
                            ...
                            '<div class="single-icon">' +
                            '<i class="" aria-hidden="true">' +
                            '<img src="img/chicaaaa.webp" width="300" height="300">' +
                            '</i>' +
                            '</div>' +
                            '</div>' +
                            '</div>' +
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-12">
                        ...
                        <div class="single-special text-center wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            <img style="margin-top: 10px;" src="./img/tendencias.webp">
                        </div>
                    </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-6" style="font-size:0;margin-bottom: -35px;">
                                <a title="Ver Promociones" href="promociones.php">
                                    <img  src="./img/fvg1.webp" style="margin-bottom: 95px;width: 245px;height: 330px;">
                                </a>
                                <a title="Ver Promociones" href="promociones.php">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-12 text-center">
                                        ...
                                        <img src="./img/fvimagen3.webp" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
